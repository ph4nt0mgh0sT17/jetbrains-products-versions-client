...
public class ProductRequest
{
    ...
    [JsonPropertyName("releases")] public List<Release?>? Releases { get; set; }

    [JsonPropertyName("forSale")] public bool? IsForSale { get; set; }
    ...
    [JsonPropertyName("alternativeCodes")] public List<string?>? AlternativeCodes { get; set; }

    [JsonPropertyName("salesCode")] public string? SalesCode { get; set; }
